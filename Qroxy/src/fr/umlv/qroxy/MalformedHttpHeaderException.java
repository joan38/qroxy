 ...
 * @author joan
 */
public class MalformedHttpHeaderException extends RuntimeException {
    ...
    public MalformedHttpHeaderException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
